...
CREATE TABLE "skill_keyword" (
    ...
    CONSTRAINT "skill_keyword_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "basic_email_key" ON "basic"("email");

-- CreateIndex
CREATE UNIQUE INDEX "basic_user_id_key" ON "basic"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "location_user_id_key" ON "location"("user_id");

-- AddForeignKey
ALTER TABLE "basic" ADD CONSTRAINT "basic_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "skill_keyword" ADD CONSTRAINT "skill_keyword_skill_id_fkey" FOREIGN KEY ("skill_id") REFERENCES "skill"("id") ON DELETE CASCADE ON UPDATE CASCADE;
